...
from core.models import Brand, Category, Partner, Product, UnitOfMeasure
...
class ProductFilter(filters.FilterSet):
    ...
    unit_of_measure_name = filters.CharFilter(
        field_name="unit_of_measure__name", lookup_expr="icontains"
    )
