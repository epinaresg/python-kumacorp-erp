...
class Company(TimeStampedModel, SoftDeleteModel):
    uuid = models.UUIDField(
        default=uuid.uuid4, unique=True, editable=False, verbose_name="UUID"
    )
...
class Product(TimeStampedModel, SoftDeleteModel):
    ...
    barcode = models.CharField(
        max_length=50, null=True, blank=True, verbose_name="Barcode"
    )
    name = models.CharField(max_length=255, verbose_name="Name")
    description = models.TextField(null=True, blank=True, verbose_name="Description")
    base_cost = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Base Cost"
    )
    base_price = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Base Price"
    )
    minimum_sale_unit = models.DecimalField(
        max_digits=10, decimal_places=3, verbose_name="Minimum Sale Unit"
    )
    minimum_unit_price = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Minimum Unit Price"
    )
