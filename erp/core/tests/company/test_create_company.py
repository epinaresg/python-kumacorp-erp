...
class CreateCompanyTestCase(APITestCase):
    ...
    def test_create_company_requires_authentication(self):
        ...
        self.assertEqual(
            ...
            "Expected 401 Unauthorized for unauthenticated company creation",
        )
    ...
    def test_create_company_fails_without_field(self):
        for field in self.required_fields:
            ...
            self.assertIn(
                field,
                response.data,
                f"Missing '{field}' in response data for bad request",
            )
    ...
    def test_create_company_succeeds_with_valid_data(self):
        ...
        self.assertEqual(
            ...
            "Expected 201 Created for successful company creation",
        )
        ...
        self.assertEqual(
            ...
            "Expected company name to match input data",
        )
        self.assertEqual(
            response.data["name"],
            self.company_data["name"],
            "Expected response name to match input data",
        )
    ...
    def test_create_company_fails_user_cannot_register_multiple_companies(self):
        ...
        self.assertEqual(
            ...
            "Expected 400 Bad Request for duplicate company creation",
        )
